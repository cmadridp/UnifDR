...
file_names_s3_trend = [
    "S3_n_400_Lambda_3_trend_crps.csv",
    "S3_n_800_Lambda_3_trend_crps.csv",
    "S3_n_1600_Lambda_3_trend_crps.csv"
]
file_names_s3_spline = [
    "S3_n_400_Lambda_3_spline_crps.csv",
    "S3_n_800_Lambda_3_spline_crps.csv",
    "S3_n_1600_Lambda_3_spline_crps.csv"
]

# File names for Scenario S4
file_names_s4_trend = [
    "S4_n_400_Lambda_3_trend_crps.csv",
    "S4_n_800_Lambda_3_trend_crps.csv",
    "S4_n_1600_Lambda_3_trend_crps.csv"
]
file_names_s4_spline = [
    "S4_n_400_Lambda_3_spline_crps.csv",
    "S4_n_800_Lambda_3_spline_crps.csv",
    "S4_n_1600_Lambda_3_spline_crps.csv"
]
...
ax.legend(
    ...
    title='Competitors', 
    title_fontsize=28,
    bbox_to_anchor=(.91, 1.02)  # Adjust x and y for fine-tuning the position
)


# Add title and labels with updated size and LaTeX formatting
ax.set_title(r'CRPS results for Scenarios ${\bf{S3}}$ and ${\bf{S4}}$ in $\Lambda_3$', fontsize=45)
