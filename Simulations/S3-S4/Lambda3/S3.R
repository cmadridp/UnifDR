...
# Save results to CSV files
write.csv(crps_trend_results, "S3_n_1600_Lambda_3_trend_crps.csv", row.names = FALSE)
write.csv(max_sq_diff_trend_results, "S3_n_1600_Lambda_3_trend_max_sq.csv", row.names = FALSE)
write.csv(crps_spline_results, "S3_n_1600_Lambda_3_spline_crps.csv", row.names = FALSE)
write.csv(max_sq_diff_spline_results, "S3_n_1600_Lambda_3_spline_max_sq.csv", row.names = FALSE)
