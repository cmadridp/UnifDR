...
file_names_s3_trend = [
    "S3_n_400_Lambda_1_trend_max_sq.csv",
    "S3_n_800_Lambda_1_trend_max_sq.csv",
    "S3_n_1600_Lambda_1_trend_max_sq.csv"
]
file_names_s3_spline = [
    "S3_n_400_Lambda_1_spline_max_sq.csv",
    "S3_n_800_Lambda_1_spline_max_sq.csv",
    "S3_n_1600_Lambda_1_spline_max_sq.csv"
]

# File names for Scenario S4
file_names_s4_trend = [
    "S4_n_400_Lambda_1_trend_max_sq.csv",
    "S4_n_800_Lambda_1_trend_max_sq.csv",
    "S4_n_1600_Lambda_1_trend_max_sq.csv"
]
file_names_s4_spline = [
    "S4_n_400_Lambda_1_spline_max_sq.csv",
    "S4_n_800_Lambda_1_spline_max_sq.csv",
    "S4_n_1600_Lambda_1_spline_max_sq.csv"
]
...
ax.legend(handles=legend_handles, fontsize=30, loc='upper right', title='Competitors', title_fontsize=30)

# Add title and labels with updated size and LaTeX formatting
ax.set_title(r'MSD results for Scenarios ${\bf{S3}}$ and ${\bf{S4}}$ in $\Lambda_1$', fontsize=45)
