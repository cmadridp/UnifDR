...
file_names_s5 = [
    "S5_n_400_Lambda_3_cart_crps.csv", "S5_n_400_Lambda_3_dnn_crps.csv",
    "S5_n_400_Lambda_3_drf_crps.csv", "S5_n_400_Lambda_3_engression_crps.csv",
    "S5_n_400_Lambda_3_mars_crps.csv", "S5_n_400_Lambda_3_rf_crps.csv",
    "S5_n_800_Lambda_3_cart_crps.csv", "S5_n_800_Lambda_3_dnn_crps.csv",
    "S5_n_800_Lambda_3_drf_crps.csv", "S5_n_800_Lambda_3_engression_crps.csv",
    "S5_n_800_Lambda_3_mars_crps.csv", "S5_n_800_Lambda_3_rf_crps.csv",
    "S5_n_1600_Lambda_3_cart_crps.csv", "S5_n_1600_Lambda_3_dnn_crps.csv",
    "S5_n_1600_Lambda_3_drf_crps.csv", "S5_n_1600_Lambda_3_engression_crps.csv",
    "S5_n_1600_Lambda_3_mars_crps.csv", "S5_n_1600_Lambda_3_rf_crps.csv"
]
...
ax.set_title(r'CRPS results for Scenario ${\bf{S5}}$ in $\Lambda_3$', fontsize=45)
