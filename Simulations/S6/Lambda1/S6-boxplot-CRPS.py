...
file_names_s5 = [
    "S6_n_400_Lambda_1_cart_crps.csv", "S6_n_400_Lambda_1_dnn_crps.csv",
    "S6_n_400_Lambda_1_drf_crps.csv", "S6_n_400_Lambda_1_engression_crps.csv",
    "S6_n_400_Lambda_1_mars_crps.csv", "S6_n_400_Lambda_1_rf_crps.csv",
    "S6_n_800_Lambda_1_cart_crps.csv", "S6_n_800_Lambda_1_dnn_crps.csv",
    "S6_n_800_Lambda_1_drf_crps.csv", "S6_n_800_Lambda_1_engression_crps.csv",
    "S6_n_800_Lambda_1_mars_crps.csv", "S6_n_800_Lambda_1_rf_crps.csv",
    "S6_n_1600_Lambda_1_cart_crps.csv", "S6_n_1600_Lambda_1_dnn_crps.csv",
    "S6_n_1600_Lambda_1_drf_crps.csv", "S6_n_1600_Lambda_1_engression_crps.csv",
    "S6_n_1600_Lambda_1_mars_crps.csv", "S6_n_1600_Lambda_1_rf_crps.csv"
]
...
ax.set_title(r'CRPS results for Scenario ${\bf{S6}}$ in $\Lambda_1$', fontsize=45)
...
file_names_s5 = [
    "S6_n_400_Lambda_1_cart_crps.csv", "S6_n_400_Lambda_1_dnn_crps.csv",
    "S6_n_400_Lambda_1_drf_crps.csv", "S6_n_400_Lambda_1_mars_crps.csv",
    "S6_n_400_Lambda_1_rf_crps.csv",  # Removed engression for n=400
    "S6_n_800_Lambda_1_cart_crps.csv", "S6_n_800_Lambda_1_dnn_crps.csv",
    "S6_n_800_Lambda_1_drf_crps.csv", # Removed engression for n=800,
    "S6_n_800_Lambda_1_mars_crps.csv", "S6_n_800_Lambda_1_rf_crps.csv",
    "S6_n_1600_Lambda_1_cart_crps.csv", "S6_n_1600_Lambda_1_dnn_crps.csv",
    "S6_n_1600_Lambda_1_drf_crps.csv", # Removed engression for n=1600,
    "S6_n_1600_Lambda_1_mars_crps.csv", "S6_n_1600_Lambda_1_rf_crps.csv"
]
...
for file_name in file_names_s5:
    parts = file_name.split('_')
    sample_size = parts[2]  # Extracting sample size
    method = parts[5].replace('.csv', '').strip().lower()  # Extracting method
...
# Prepare data for box plot, excluding 'engression' for n=400
for sample_size in sorted(s5_data.keys()):
    for method in method_colors.keys():
        if method == "engression" and sample_size == 400:
            continue  # Skip engression for n=400
        if method == "cart" and sample_size == 400:
            continue  # Skip engression for n=400
        if method == "cart" and sample_size == 800:
            continue  # Skip engression for n=400
        if method == "mars" and sample_size == 400:
            continue  # Skip engression for n=400
        if method == "mars" and sample_size == 800:
            continue  # Skip engression for n=400
        if method == "engression" and sample_size == 800:
            continue  # Skip engression for n=400
        if method == "engression" and sample_size == 1600:
            continue  # Skip engression for n=400
        if method == "rf" and sample_size == 400:
            continue  # Skip engression for n=400
        if method in s5_data[sample_size]:
            plot_data.append(s5_data[sample_size][method])
            labels.append(f'n={sample_size}\n{method.upper()}')
...
# Customize x-axis labels to group by sample size
grouped_labels = [f'n={size}' for size in sorted(s5_data.keys())]
ax.set_xticks([1.5 + 3.5 * i for i in range(len(grouped_labels))])  # Adjust spacing
ax.set_xticklabels(grouped_labels, fontsize=27)
...
# Customize x-axis labels to group by sample size
grouped_labels = [f'n={size}' for size in sorted(s5_data.keys())]
ax.set_xticks([2.5 + 4.2 * i for i in range(len(grouped_labels))])  # Adjust spacing
ax.set_xticklabels(grouped_labels, fontsize=27)
...
# File names for Scenario S5
file_names_s5 = [
    "S6_n_400_Lambda_1_dnn_crps.csv", "S6_n_400_Lambda_1_drf_crps.csv",
    "S6_n_800_Lambda_1_dnn_crps.csv", "S6_n_800_Lambda_1_drf_crps.csv",
    "S6_n_1600_Lambda_1_dnn_crps.csv", "S6_n_1600_Lambda_1_drf_crps.csv"
]
