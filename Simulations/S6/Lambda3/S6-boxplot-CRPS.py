...
file_names_s5 = [
    "S6_n_400_Lambda_3_cart_crps.csv", "S6_n_400_Lambda_3_dnn_crps.csv",
    "S6_n_400_Lambda_3_drf_crps.csv", "S6_n_400_Lambda_3_engression_crps.csv",
    "S6_n_400_Lambda_3_mars_crps.csv", "S6_n_400_Lambda_3_rf_crps.csv",
    "S6_n_800_Lambda_3_cart_crps.csv", "S6_n_800_Lambda_3_dnn_crps.csv",
    "S6_n_800_Lambda_3_drf_crps.csv", "S6_n_800_Lambda_3_engression_crps.csv",
    "S6_n_800_Lambda_3_mars_crps.csv", "S6_n_800_Lambda_3_rf_crps.csv",
    "S6_n_1600_Lambda_3_cart_crps.csv", "S6_n_1600_Lambda_3_dnn_crps.csv",
    "S6_n_1600_Lambda_3_drf_crps.csv", "S6_n_1600_Lambda_3_engression_crps.csv",
    "S6_n_1600_Lambda_3_mars_crps.csv", "S6_n_1600_Lambda_3_rf_crps.csv"
]
...
ax.set_title(r'CRPS results for Scenario ${\bf{S6}}$ in $\Lambda_3$', fontsize=45)
...
file_names_s5 = [
    "S6_n_400_Lambda_3_cart_crps.csv", "S6_n_400_Lambda_3_dnn_crps.csv",
    "S6_n_400_Lambda_3_drf_crps.csv", "S6_n_400_Lambda_3_mars_crps.csv",
    "S6_n_400_Lambda_3_rf_crps.csv",  # Removed engression for n=400
    "S6_n_800_Lambda_3_cart_crps.csv", "S6_n_800_Lambda_3_dnn_crps.csv",
    "S6_n_800_Lambda_3_drf_crps.csv", # Removed engression for n=800,
    "S6_n_800_Lambda_3_mars_crps.csv", "S6_n_800_Lambda_3_rf_crps.csv",
    "S6_n_1600_Lambda_3_cart_crps.csv", "S6_n_1600_Lambda_3_dnn_crps.csv",
    "S6_n_1600_Lambda_3_drf_crps.csv", "S6_n_1600_Lambda_3_engression_crps.csv",
    "S6_n_1600_Lambda_3_mars_crps.csv", "S6_n_1600_Lambda_3_rf_crps.csv"
...
# Customize x-axis labels to group by sample size
grouped_labels = [f'n={size}' for size in sorted(s5_data.keys())]
ax.set_xticks([2. + 4 * i for i in range(len(grouped_labels))])  # Adjust spacing
ax.set_xticklabels(grouped_labels, fontsize=27)
...
# File names for Scenario S5
file_names_s5 = [
    "S6_n_400_Lambda_3_dnn_crps.csv", "S6_n_400_Lambda_3_drf_crps.csv",
    "S6_n_800_Lambda_3_dnn_crps.csv", "S6_n_800_Lambda_3_drf_crps.csv",
    "S6_n_1600_Lambda_3_dnn_crps.csv", "S6_n_1600_Lambda_3_drf_crps.csv"
]
