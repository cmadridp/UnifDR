...
file_names_s1 = [
    "S1_n_400_Lambda_1_crps_1.csv",
    "S1_n_800_Lambda_1_crps_1.csv",
    "S1_n_1600_Lambda_1_crps_1.csv"
]
file_names_s2 = [
    "S2_n_400_Lambda_1_crps.csv",
    "S2_n_800_Lambda_1_crps.csv",
    "S2_n_1600_Lambda_1_crps.csv"
]
...
ax.set_title(r'CRPS results for Scenarios ${\bf{S1}}$ and ${\bf{S2}}$ in $\Lambda_1$', fontsize=45)
