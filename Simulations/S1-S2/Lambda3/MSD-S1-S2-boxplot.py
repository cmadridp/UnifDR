...
file_names_s1 = [
    "S1_n_400_Lambda_3_max_sq.csv",
    "S1_n_800_Lambda_3_max_sq.csv",
    "S1_n_1600_Lambda_3_max_sq.csv"
]
file_names_s2 = [
    "S2_n_400_Lambda_3_max_sq.csv",
    "S2_n_800_Lambda_3_max_sq.csv",
    "S2_n_1600_Lambda_3_max_sq.csv"
]
...
ax.set_title(r'MSD results for Scenarios ${\bf{S1}}$ and ${\bf{S2}}$ in $\Lambda_3$', fontsize=45)
