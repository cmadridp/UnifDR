...
output_dir <- "/Users/carlos/Desktop/Scenario1 and 2/Lambda3"
if (!dir.exists(output_dir)) {
  dir.create(output_dir, recursive = TRUE) # Create the directory if it doesn't exist
}

# Save results to CSV files
write.csv(crps_results, "S1_n_1600_Lambda_3_crps.csv", row.names = FALSE)
write.csv(max_sq_diff_results, "S1_n_1600_Lambda_3_max_sq.csv", row.names = FALSE)
