...
file_names_s1 = [
    "S1_n_400_Lambda_3_crps.csv",
    "S1_n_800_Lambda_3_crps.csv",
    "S1_n_1600_Lambda_3_crps.csv"
]
file_names_s2 = [
    "S2_n_400_Lambda_3_crps.csv",
    "S2_n_800_Lambda_3_crps.csv",
    "S2_n_1600_Lambda_3_crps.csv"
]
...
ax.set_title(r'CRPS results for Scenarios ${\bf{S1}}$ and ${\bf{S2}}$ in $\Lambda_3$', fontsize=45)
