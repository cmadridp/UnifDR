...
write.csv(crps_results, file.path(output_dir, "S2_n_1600_Lambda_2_crps.csv"), row.names = FALSE)
write.csv(max_sq_diff_results, file.path(output_dir, "S2_n_1600_Lambda_2_max_sq.csv"), row.names = FALSE)
